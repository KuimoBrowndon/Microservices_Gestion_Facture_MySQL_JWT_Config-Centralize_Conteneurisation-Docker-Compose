...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        ...
        http.authorizeRequests().antMatchers(HttpMethod.POST,"/api/**").hasAnyAuthority("ADMIN","BILL_MANAGER");
        http.authorizeRequests().antMatchers(HttpMethod.PUT,"/api/**").hasAnyAuthority("ADMIN","BILL_MANAGER");
        http.authorizeRequests().antMatchers(HttpMethod.DELETE,"/api/**").hasAnyAuthority("ADMIN","BILL_MANAGER");
